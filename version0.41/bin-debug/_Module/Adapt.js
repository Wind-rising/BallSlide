...
var Adapt = (function () {
    ...
    */
    ...
    Adapt.prototype.radianToAngle = function (radian) {
    ...
    */
    ...
    /*
        ...
        a = F/m;
    */
    Adapt.prototype.powerDispersed = function (_a) {
        var m = _a.m, rotation = _a.rotation, _b = _a.μs, μs = _b === void 0 ? 0 : _b, _c = _a.μk, μk = _c === void 0 ? 0 : _c;
        var F = 0;
        var G = 9.8 / m;
        if ((rotation / 180) % 2 == 0) {
            /*
