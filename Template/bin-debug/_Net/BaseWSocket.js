...
/**webSocket */
var BaseWSocket = (function () {
    function BaseWSocket(p) {
        this.parent = null;
        this.parent = p;
    ...
    /**连接失败 */ /**应该重连 */ /** */
    BaseWSocket.prototype.onSocketClose = function () {
    ...
    /**连接错误 */ /**应该重连 */
    BaseWSocket.prototype.onSocketError = function (e) {
        console.log("错误代码：" + e.error);
        /**重新连接 */
        //BaseWSocket.webSocket.connect(BaseWSocket.strIp, 8999); 
    };
    /**接收到数据 */
    BaseWSocket.prototype.onReceiveMessage = function (e) {
...
__reflect(BaseWSocket.prototype, "BaseWSocket");
//# sourceMappingURL=BaseWSocket.js.map